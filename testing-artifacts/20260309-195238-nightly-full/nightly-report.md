...
- mode: `nightly`
- started_at: `2026-03-09T19:52:38+08:00`
- finished_at: `2026-03-09T19:55:29+08:00`
- summary: `passed=189`, `failed=102`, `skipped=0`, `total=291`
...
| L3-CROSS-END-SUITE | L3 | failed | P1 | order ops checkout unexpected errno=412, status=200, errmsg=请先完善登录资料 |
| L3-ORDER-OPS-CROSS-END | L3 | failed | P1 | blocked by cross-end suite runtime error: order ops checkout unexpected errno=412, status=200, errmsg=请先完善登录资料 |
...
| L3-COUPON-CROSS-END | L3 | passed | P1 | coupon_id=136, user_coupon_id=135 |
| L3-PROMOTION-CROSS-END | L3 | passed | P1 | promotion_id=20, goods_id=1009012 |
...
| L2-AD-MESSAGE-FLOW | L2 | passed | P2 | before=0, after=0, user_ad_read_before=1, user_ad_read_after=1 |
| L2-INVITE-FLOW | L2 | passed | P2 | schema_ready=1, invite_total=0 |
| L3-AD-CROSS-END | L3 | passed | P2 | ad_id=34, popup_id=34, unread_before=1, unread_after=0 |
...
RuntimeError: goods stock decrement expected 1, got before=78, after=78`
...
- `L3-CROSS-END-SUITE` [P1] Cross-end suite runtime: order ops checkout unexpected errno=412, status=200, errmsg=请先完善登录资料
- `L3-ORDER-OPS-CROSS-END` [P1] Admin order memo/status -> mini order detail consistency: blocked by cross-end suite runtime error: order ops checkout unexpected errno=412, status=200, errmsg=请先完善登录资料
