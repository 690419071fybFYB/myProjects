...
- mode: `nightly`
- started_at: `2026-03-09T20:12:46+08:00`
- finished_at: `2026-03-09T20:15:19+08:00`
- summary: `passed=192`, `failed=99`, `skipped=0`, `total=291`
...
|---|---|---|---|---|
| L2-COUPON-LIFECYCLE | L2 | failed | P0 | 5) 在线单：支付后核销 |
...
| L3-COUPON-CROSS-END | L3 | passed | P1 | coupon_id=145, user_coupon_id=144 |
| L3-PROMOTION-CROSS-END | L3 | passed | P1 | promotion_id=23, goods_id=1009012 |
...
| L1-FULL-API-ACTIONS | L1 | failed | P2 | actions=68, failed=19, skipped=0 |
...
| L1-FULL-API-ACTIONS::footprint.delete | L1 | failed | P2 | status=500 server error |
...
| L1-FULL-API-ACTIONS::order.complete | L1 | failed | P2 | status=500 server error |
| L1-FULL-API-ACTIONS::order.express | L1 | failed | P2 | status=500 server error |
| L1-FULL-API-ACTIONS::order.submit | L1 | failed | P2 | status=500 server error |
...
| L2-SEARCH-FOOTPRINT | L2 | passed | P2 | keyword=qa-search-1773058515, footprint_id=15670 |
| L3-ADMIN-AUTH-PREREQ | L3 | passed | P2 | admin token acquired |
| L4-MINI-SYNTAX-SMOKE | L4 | passed | P2 | syntax checks passed |

## Failures (With Repro)

- `L2-COUPON-LIFECYCLE` [P0] Coupon receive/preview/lock/use/release flow: 5) 在线单：支付后核销
  - repro_step: run `node scripts/test-coupon.js`
  - evidence: `Coupon 自动化测试失败: [/api/pay/preWeixinPaya] 非JSON响应: <!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
...
- `L2-PAY-FLOW` [P0] Pay notify and idempotency flow: notify results: ok=1, fail=0
  - repro_step: run `python3 testing/scripts/pay_notify_concurrency.py --base-url http://127.0.0.1:8360 --workers 1 --user-id 1048 --api-jwt-secret bae4fdabcc11cba5bb4aa9225bdbda8a936b41d729e86a65f44c02313d839278 --db-host 127.0.0.1 --db-port 3306 --db-user root --db-password CHANGE_ME_STRONG_PASSWORD --db-name hiolabsDB`
...
RuntimeError: goods stock decrement expected 1, got before=69, after=69`
...
- `NIGHTLY-NOTIFY-CONCURRENCY` [P0] Pay notify concurrency and idempotency consistency: RuntimeError: notify failures: ['OK', 'OK', 'OK']
  - repro_step: run `python3 testing/scripts/pay_notify_concurrency.py --base-url http://127.0.0.1:8360 --workers 8 --user-id 1048 --api-jwt-secret bae4fdabcc11cba5bb4aa9225bdbda8a936b41d729e86a65f44c02313d839278 --db-host 127.0.0.1 --db-port 3306 --db-user root --db-password CHANGE_ME_STRONG_PASSWORD --db-name hiolabsDB`
  - evidence: `Traceback (most recent call last):
  File "/Volumes/SAMSUNG/fyb/myProjects/testing/scripts/pay_notify_concurrency.py", line 383, in <module>
    raise SystemExit(main())
                     ~~~~^^
...
<head>
	...
	<style>
		...
		body,code,dd,div,dl,dt,h1,h2,h3,h4,h5,h6,li,pre,ul{margin:0;padding:0}a{text-decoration:none}.clearfix{clear:both;zoom:1}.clearfix:after{clear:both;content:"";display:block;height:0;vis`
- `L1-FULL-API-ACTIONS` [P2] All API actions contract probing: actions=68, failed=19, skipped=0
...
- `L1-FULL-API-ACTIONS::crontab.timetask` [P2] API contract crontab.timetask: status=200 non-json response
  ...
  - evidence: `OK`
- `L1-FULL-API-ACTIONS::footprint.delete` [P2] API contract footprint.delete: status=500 server error
...
<div class="wrap">
    <div class="top`
- `L1-FULL-API-ACTIONS::order.complete` [P2] API contract order.complete: status=500 server error
...
<head>
	...
	<style>
		...
		body,code,dd,div,dl,dt,h1,h2,h3,h4,h5,h6,li,pre,ul{margin:0;padding:0}a{text-decoration:none}.clearfix{clear:both;zoom:1}.clearfix:after{clear:both;content:"";display:block;height:0;vis`
- `L1-FULL-API-ACTIONS::order.express` [P2] API contract order.express: status=500 server error
...
<head>
	...
	<style>
		...
		body,code,dd,div,dl,dt,h1,h2,h3,h4,h5,h6,li,pre,ul{margin:0;padding:0}a{text-decoration:none}.clearfix{clear:both;zoom:1}.clearfix:after{clear:both;content:"";display:block;height:0;vis`
- `L1-FULL-API-ACTIONS::order.submit` [P2] API contract order.submit: status=500 server error
