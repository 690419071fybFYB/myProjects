...
- mode: `pr-gate`
- started_at: `2026-03-07T00:01:21+08:00`
- finished_at: `2026-03-07T00:01:23+08:00`
- summary: `passed=1`, `failed=21`, `skipped=4`, `total=26`
...
| L3-CROSS-END-SUITE | L3 | failed | P1 | Traceback (most recent call last):   File "/Volumes/SAMSUNG/fyb/myProjects/testing/scripts/cross_end_suite.py", line 372, in <module>     raise SystemExit(main())               ... |
...
| L4-MINI-REQUEST-SMOKE | L4 | failed | P1 | [telemetry] {   ts: 1772812883463,   event: 'request',   route: 'pages/index/index',   payload: {     networkType: 'unknown',     url: 'http://example.com/ok',     method: 'GET'... |
...
- `L3-CROSS-END-SUITE` [P1] L3 cross-end suite: Traceback (most recent call last):
  File "/Volumes/SAMSUNG/fyb/myProjects/testing/scripts/cross_end_suite.py", line 372, in <module>
    raise SystemExit(main())
                     ~~~~^^
  File "/Volumes/SAMSUNG/fyb/myProjects/testing/scripts/...
  - command: `python3 testing/scripts/cross_end_suite.py --base-url http://127.0.0.1:1 --api-jwt-secret ci_api --admin-jwt-secret ci_admin --api-user-id 1 --admin-user-id 14 --admin-username qilelab.com --admin-password qilelab.com --db-host 127.0.0.1 --db-port 3306 --db-user root --db-password root --db-name hiolabsDB --output /Volumes/SAMSUNG/fyb/myProjects/testing-artifacts/20260307-000121-pr-gate/layers/l3-cross-end.json`
  - evidence: `Traceback (most recent call last):
  File "/Volumes/SAMSUNG/fyb/myProjects/testing/scripts/cross_end_suite.py", line 372, in <module>
    raise SystemExit(main())
                     ~~~~^^
  File "/Volumes/SAMSUNG/fyb/myProjects/testing/scripts/cross_end_suite.py", line 353, in main
    results = run_suite(cfg)
  File "/Volumes/SAMSUNG/fyb/myProjects/testing/scripts/cross_end_suite.py", line 149, in run_suite
    conn = db_connect(cfg)
  File "/Volumes/SAMSUNG/fyb/myProjects/testing/scripts/cr`
...
- `L4-MINI-REQUEST-SMOKE` [P1] Mini request SDK smoke: [telemetry] {
  ts: 1772812883463,
  event: 'request',
...
[telemetry] {
  ts: 1772812883464,
  event: 'req
  - command: `node testing/scripts/miniprogram_request_smoke.js`
